...
- Name: pwa.spec.js >> PWA Installability >> manifest link in head
- Location: tests/pwa.spec.js:32:3
...
Locator:  locator('link[rel="manifest"]').first()
Expected: visible
Received: hidden
Timeout:  5000ms
...
Call log:
  ...
  - waiting for locator('link[rel="manifest"]').first()
    14 × locator resolved to <link rel="manifest" href="/manifest.json"/>
...
```yaml
- text: 🌴
- heading "Tarteel Tots" [level=1]
- paragraph: Quran memorization for little ones
- heading "Parent Login" [level=2]
- text: Email
- textbox "parent@example.com"
- text: Password
- textbox "••••••••"
- button "Login"
- paragraph:
